...
نسخه‌های major شماره ۱ با برچسب «ویرایش اول» و نسخه‌های major شماره ۲ با برچسب «ویرایش دوم» ساخته می‌شن. برای major بعدی باید اول نگاشت و نام ویرایش به‌صورت صریح در `book/release-metadata.mjs` اضافه و بازبینی بشه؛ در غیر این صورت ساخت متوقف می‌شه.
